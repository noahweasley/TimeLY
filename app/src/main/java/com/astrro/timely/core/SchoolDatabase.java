...
public class SchoolDatabase extends SQLiteOpenHelper {
   ...
   public boolean isTimeTableAbsent(String timetable, TimetableModel model) {
      ...
      if (timetable.equals(SCHEDULED_TIMETABLE)) {
         ...
         searchCursor = db.rawQuery(search_stmt1, null);
      }
   ...
   public Map<String, Integer> getTodoGroupSizes() {
      ...
      todoMap.put(todoGroups[0], generalGroupSize);
   ...
   public long[] addTodo(TodoModel todoModel, String category) {
      ...
      String getIdStmt = "SELECT " + COLUMN_ID + " FROM " + category;
      Cursor idCursor = db.rawQuery(getIdStmt, null);
