...
import static com.astrro.timely.alarms.AlarmReceiver.ID;
...
public class NotificationActionReceiver extends BroadcastReceiver {
   ...
   private void snoozeAlarmFor(int snoozeTime, Intent intent, Context context) {
      ...
      Uri data = Uri.parse("content://com.astrro.timely/Alarms/alarm" + rTime);
      alarmReceiverIntent.setDataAndType(data, "com.astrro.timely.alarm.dataType");
